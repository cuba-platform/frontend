...
Define a query as described {manual_restApi}#rest_api_v2_queries_config[here].
...
Expose a service and it's method as described {manual_restApi}#rest_api_v2_services_config[here]. Use https://cuba-elements.github.io/cuba-elements/components/cuba-data/#cuba-service[cuba-service] element
...
[TIP]
====
You should enable {manual_restApi}#rest_api_v2_anonymous[anonymous access] in the REST API if you want to use the examples above without forcing users to log in.
====
