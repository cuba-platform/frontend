...
sw-precache-config.js:: Config used by https://github.com/GoogleChrome/sw-precache[sw-precache] library in order to generate service worker at build time (disabled by default). See xref:client-polymer:polymer/polymer_offline.adoc[Offline Capabilities].
