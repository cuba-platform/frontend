...
Same as link:#react-typescript-entity-management[react-typescript:entity-management] but implemented using https://reactjs.org/docs/hooks-intro.html[React Hooks] rather than classes.
