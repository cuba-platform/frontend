...
In this guide we will use the Frontend Generator to create a starter React client and add screens to browse and edit an entity.

There are two ways to use the generator: from Jmix Studio and from CLI.
...
- Enter a name for the CRUD component, it is a component that renders a List component (i.e. an entity browser) or an Edit component (i.e. an entity editor) depending on which route is active.
