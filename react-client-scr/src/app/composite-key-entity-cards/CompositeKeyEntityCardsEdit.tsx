...
@injectMainStore
@observer
class CompositeKeyEntityCardsEditComponent extends React.Component<
...
> {
  ...
  isNewEntity = () => {
    return this.props.entityId === CompositeKeyEntityManagement3.NEW_SUBPATH;
  };

  render() {
    if (this.updated) {
      return <Redirect to={CompositeKeyEntityManagement3.PATH} />;
    }
      ...
      <Card className="narrow-layout">
        ...
        >
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={CompositeKeyEntityManagement3.PATH}>
...
export default injectIntl(CompositeKeyEntityCardsEditComponent);
