...
@injectMainStore
@observer
class CompositeKeyEntityListEditComponent extends React.Component<
...
> {
  ...
  isNewEntity = () => {
    return this.props.entityId === CompositeKeyEntityManagement2.NEW_SUBPATH;
  };

  render() {
    if (this.updated) {
      return <Redirect to={CompositeKeyEntityManagement2.PATH} />;
    }
      ...
      <Card className="narrow-layout">
        ...
        >
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={CompositeKeyEntityManagement2.PATH}>
...
export default injectIntl(CompositeKeyEntityListEditComponent);
