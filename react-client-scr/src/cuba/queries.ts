...
export var restQueries = {
  Car: {
    allCars: (cubaApp: CubaApp, fetchOpts?: FetchOptions) => (): Promise<
      SerializedEntity<Car>[]
    > => {
      return cubaApp.query<Car>("scr$Car", "allCars", {}, fetchOpts);
    },
    allCarsCount: (cubaApp: CubaApp, fetchOpts?: FetchOptions) => (): Promise<
      Number
    > => {
    ...
    carsByTypeWithCount: (cubaApp: CubaApp, fetchOpts?: FetchOptions) => (
      ...
      return cubaApp.queryWithCount<Car>(
        "scr$Car",
        "carsByType",
        params,
        fetchOpts
  ...
  FavoriteCar: {
    allCars: (cubaApp: CubaApp, fetchOpts?: FetchOptions) => (
      ...
      return cubaApp.query<FavoriteCar>(
        "scr$FavoriteCar",
        "allCars",
        params,
        fetchOpts
