...
Generates a React starter app. See xref:client-react:starter-guide.adoc[开始使用 React Client].
...
Generates a React Native starter app. See xref:client-react-native:starter-guide.adoc[开始使用 React Native Client].
