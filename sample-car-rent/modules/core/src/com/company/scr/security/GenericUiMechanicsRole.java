...
@Role(name = GenericUiMechanicsRole.NAME)
public class GenericUiMechanicsRole extends AnnotatedRoleDefinition {

    public static final String NAME = "generic-ui-mechanics";
