...
export var restServices = {
  mpg_FavoriteService: {
    ...
    getFavoritesByType: (cubaApp: CubaApp, fetchOpts?: FetchOptions) => (params: mpg_FavoriteService_getFavoritesByType_params) => {
      return cubaApp.invokeService("mpg_FavoriteService", "getFavoritesByType", params, fetchOpts);
    }
  }
};
